...
const { webuser_member_type } = proxy.useDict("webuser_member_type");

	


const columns = ref([
  { title: '用户ID', field: 'userId' ,search: true},
  { title: '账号', field: 'email',search: true },
  ...
  { title: '用户类型', field: 'memberType' ,type: 'select',search: true,options: webuser_member_type, },
  { title: '会员过期时间', field: 'expireTime',type: 'dateTime' },
